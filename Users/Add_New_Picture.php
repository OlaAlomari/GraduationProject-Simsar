...
$insert = mysqli_query($dbConn,"insert into real_estates_pictures (RE_ID,Picture_Path) values ('$RE_ID','$Picture')");
...
echo "<script language='JavaScript'>
			  alert ('New Picture Has Been Added Successfully !');
      </script>";
...
<a class="dropdown-item" href="My_Account.php">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
		   ...
		   Real Estates
		  <br>
		  Add New SimSar Picture Information
...
<form method="post" action="Add_New_Picture.php?RE_ID=<?php echo $RE_ID; ?>" enctype="multipart/form-data">
								<input type="hidden" name="RE_ID" value="<?php echo $RE_ID; ?>"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <label class="control-label" for="couplename">Picture</label>
                                                            <input id="couplename" type="file" name="file" required class="form-control ">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="social-form-info mb-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <button class="btn btn-primary" name="Submit" type="submit">Add New SimSar Picture</button>
