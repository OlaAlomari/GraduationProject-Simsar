...
(function ($) {
    ...
    $("#price-range").slider({
        ...
        slide: function (event, ui) {
            $("#priceRange").val("[" + ui.values[0] + "-" + ui.values[1] + "]" + "JD");
        }
    });
    $("#priceRange").val("[" + $("#price-range").slider("values", 0) + "-" + $("#price-range").slider("values", 1) + "]" + "JD");
    ...
    $("#price-range-P").slider({
        ...
        values: [50, 120000],
        slide: function (event, ui) {
            $("#priceRangeP").val("[ " + "JD" + ui.values[0] + " - " + "JD" + ui.values[1] + " ]");
        }
    });
    $("#priceRangeP").val("[ " + "JD" + $("#price-range-P").slider("values", 0) + " - " + "JD" + $("#price-range-P").slider("values", 1) + " ]");
