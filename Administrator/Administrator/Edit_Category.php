...
mysqli_query($dbConn,"update categories set Category_Name='$Category_Name' where ID='$C_ID'");
...
<form method="post" action="Edit_Category.php?C_ID=<?php echo $C_ID; ?>">
							<input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <label class="control-label" for="couplename">Category Name</label>
                                                            <input id="couplename" type="text" placeholder="Category Name" name="Category_Name" value="<?php echo $Category_Name; ?>" required class="form-control ">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="social-form-info mb-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <button class="btn btn-primary" name="Submit" type="submit">Edit Category</button>
