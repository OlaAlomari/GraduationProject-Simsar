...
mysqli_query($dbConn,"update real_estates set Status='$Status' where ID='$RE_ID'");
...
echo "<script language='JavaScript'>
			  alert ('SimSar Information Has Been Updated !');
      </script>";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  Real Estates List
		  <br>
		  Edit SimSar Information

        <div class="card-body">
             
			 
			
<form method="post" action="Edit_Real_Estate.php?RE_ID=<?php echo $RE_ID; ?>" enctype="multipart/form-data">
							<input type="hidden" name="RE_ID" value="<?php echo $RE_ID; ?>"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <label class="control-label" for="couplename">Status</label>
                                                            <select id="couplename" name="Status" required class="form-control">
                                            ...
                                            <div class="social-form-info mb-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <button class="btn btn-primary" name="Submit" type="submit">Edit SimSar</button>
