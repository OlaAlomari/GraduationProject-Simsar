    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card-body">
			...
			<form method="post" action="Add_New_Category.php">
                                            <!-- Form Name -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="couplename" type="text" placeholder="Category Name" name="Category_Name" required class="form-control ">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="social-form-info mb-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <button class="btn btn-primary" name="Submit" type="submit">Add New Category</button>
