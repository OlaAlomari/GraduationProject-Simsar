...
mysqli_query($dbConn,"update users set  Status='$Status' where ID='$U_ID'");
...
echo "<script language='JavaScript'>
	...
	echo "<script language='JavaScript'>
document.location='View_User_List.php';
        </script>";
...
<form method="post" action="Edit_User.php?U_ID=<?php echo $U_ID; ?>" enctype="multipart/form-data">
