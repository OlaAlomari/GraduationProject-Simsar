    ...
    <section class="howit-works spad">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                 <center><h4> the go-to destination for all your real estate needs. We are a team who are committed to providing our users with the best possible service.
                     </h4></center>
                 <center><h4> Our user-friendly platform makes it easy for you to search for properties, connect with agents, and stay up-to-date on the latest real estate trends.</h4></center>
                 <center><h4>tWe strive to make the home buying and selling process as seamless as possible.</h4></center>
